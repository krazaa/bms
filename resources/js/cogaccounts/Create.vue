            ...
            <div class="box">
                ...
                <div class="field">
                     <div class="field">
                        ...
                        <div class="control">
                            <div class="select">
                                <select name="typeid" v-model="cogFrom.htype" @input="GetSubHeads()" required>
                ...
                <div class="column is-4">
                    <div class="field">
                        ...
                        <div class="control">
                            <input class="input" v-model="cogFrom.aname" name="aname" type="text" placeholder="e.g Honda 125">
                ...
                <div class="column is-3">
                        <div class="field">
                            ...
                            <div class="control">
                                <div class="select">
                                    <select name="incom_balance_id" required>
                                        <option selected disabled>Select one</option>
                    ...
                    <div class="column is-3">
                        <div class="field">
                            ...
                            <div class="control">
                                <div class="select">
                                    <select name="debitcredit" required>
                                        <option selected disabled>Select one</option>
                    ...
                    <div class="column is-3">
                        <div class="field">
                            ...
                            <div class="control">
                                <div class="select">
                                    <select name="actype_id" required>
                                        <option selected disabled>Select one</option>
