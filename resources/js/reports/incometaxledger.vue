    ...
    <template>
       <section v-if="getdata.length > 0">
           <div class="columns is-multiline">
            <div class="column is-4"><h3 class="title is-4">INCOME TAX ACCOUNT LEDGER</h3></div>
        ...
        <b-table-column field="name" label="Type" sortable>
        {{ props.row.products.name }}
        </b-table-column>
        <b-table-column field="date_at" label="Date" sortable>
        {{ props.row.date_at}}  
        </b-table-column>
        <b-table-column field="poid" label="PO Number" sortable>
        {{ props.row.ponumbers.poid }}
        </b-table-column>
