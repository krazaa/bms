    ...
    <section>
        ...
        <tbody>
            <tr v-for="(dload, index)  in Dataload">
                ...
                <td>{{ dload.fstcost = dload.qty * dload.cost | currency}}</td> 

                <td>Cargo {{ totalcargo = CargoAll * cargopo / dload.fstcost| currency}} 
                        
                    
                </td>
                <td>Cargo PU {{ cargocost = totalcargo / dload.qty | currency }}</td>
                    <td>
                        Cost with CArgo {{ dload.totalcost = dload.cost + cargocost }}
                    </td>
                    <td>
                        wholesalepo {{  PricCargonprofit }}
                        <b-input type="number" v-model="dload.postwsp"> </b-input>

                        
                       

                        <!-- <b-input type="number" v-model="dload.wsprice"> </b-input> -->
                        
                    </td>
                    <td>
                        <!-- <input type="hidden" v-model="dload.wolSale = totalWholeSale"> -->
                        <!-- <b-input type="number" name="wsaleprice" v-model="dload.totalWholeSale" readonly></b-input> -->
                    </td>
                    
                    <td>
                        <!-- <b-input type="number" v-model="dload.wspp = dload.sprice"> </b-input> -->
                    </td> 
                  <!--  <td>
                        <!-- <input type="hidden" v-model="dload.salPrice = totalSalePrice"> -->
                <!--         <b-input type="number" name="saleprice" v-model="dload.totalSalePrice" readonly>
                        </b-input> -->
                        ...
                        <!-- <input name="cargo" type="number" class="input" v-model="dload.cargoamount = cargo"></td> -->
                    </td>
        ...
        <tfoot>
            ...
            <tr>
                ...
                <td>
                Total Cargo <b-input type="number" v-model="cargopo"> </b-input>
            </td>
            </tr>
            <tr>
                <td colspan="9"></td>
...
export default {
     components: {
        ...
        computed: {
            ...
            PricCargonprofit: function() {
            return this.Dataload.reduce((total, dload) => {
            return total += parseInt(dload.postwsp) + parseInt(dload.totalcost);
          }, 0);
            },
/////////////////////////////////////
          //   incomtax: function() {
          //        return this.Dataload.reduce((total, dload) => {
          //   return total = parseInt((dload.taxpage / 100)) * parseInt(dload.total);
          // }, 0);
          //   // let total = 0;    
          ...
          //    totalWholeSale: function() {

          //   return this.Dataload.reduce((total, dload) => {
          //   return total = parseInt(dload.hsp) * parseInt(dload.totalcost);
          // }, 0);
          //       // let total = 0;    
          //       // return  total +=  parseInt(this.hsp) + parseInt(this.dload.totalcost);
          //     },
          ...
          //       return this.Dataload.reduce((total, dload) => {
          //   return total + parseInt(dload.wspp) * parseInt(dload.totalcost);
          // }, 0);
          //    // let total = 0;    
