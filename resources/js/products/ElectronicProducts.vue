    ...
    <div class="box">
        <b-field grouped group-multiline>
         <div class="control">
            ...
            <div class="control">
                <b-field>
                    <a href="products./electronic/" class="button is-info">New Product</a>
                </b-field>
            </div>
    </b-field>
      <table class="table is-fullwidth is-hoverable is-narrow is-desktop is-mobile" v-if="products.length > 0">
        ...
        <thead>
          <tr>
            ...
            <th><abbr title="products">Products</abbr></th>
        ...
        <tbody>
          <tr v-for="(product , index) in products">
            ...
            <td>{{ product.cost }}</td>
            <td>
                <a :href="`/products./electronic/ShowSingle/${product.id}`" class="button is-success is-small"><span class="mdi mdi-eye-circle-outline"></span></a>
                <a :href="`/products./electronic/ShowEdit/${product.id}`" class="button is-warning is-small"><span class="mdi mdi-pencil-box-outline"></span></a>
                <a :href="`/products./electronic/ProductRemove/${product.id}`" class="button is-danger is-small"><span class="mdi mdi-trash-can"></span></a>
            </td>
          </tr>
        </tbody>
      </table>
